...
<ul>
  <li>
    <p> Check out my latest 4-day Sprint here. Coded out OOP and functions for a number of advance data structures and algorithm, including Dijkstra Algorithm, merge sort, Graphs, Binary Trees, and Heaps. Modules can be quickly imported for immediate usage through git pull. <a href="https://github.com/Kern000/advance-data-structures" target="_blank"> Link to repo here </a> </p>
